    ...
    <main class="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div class="w-full max-w-md border-4 border-black p-6 md:p-8 bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div class="text-center mb-6">
                <h2 class="text-3xl font-black tracking-tighter uppercase italic leading-none mb-2">Register</h2>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <div class="space-y-1">
                    <label for="name" class="text-xs font-black uppercase tracking-widest block">Full_Name</label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                            <i class="fas fa-user text-gray-400"></i>
                        </span>
                        <input type="text" id="name" name="name" value="{{ old('name') }}" required autofocus
                               class="w-full border-4 border-black pl-10 pr-3 py-3 font-bold focus:outline-none focus:bg-cyan-50 focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all uppercase" 
                ...
                <div class="space-y-1">
                    <label for="password_confirmation" class="text-xs font-black uppercase tracking-widest block">Confirm_Password</label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-3">
            ...
            <div class="relative my-5 text-center select-none">
            ...
            <a href="/auth/google" class="w-full bg-white border-4 border-black py-3.5 font-black text-xs uppercase tracking-widest shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all flex items-center justify-center gap-3">
                <i class="fab fa-google text-lg"></i> Sign up with Google
            </a>

            <div class="mt-6 text-center">
                <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">
                    Sudah punya akun? 
                    <a href="{{ route('login') }}" class="text-black font-black underline decoration-2 decoration-cyan-500 hover:text-cyan-500 transition">Login</a>
                </p>
            </div>
